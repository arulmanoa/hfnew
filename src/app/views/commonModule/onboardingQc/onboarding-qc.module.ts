...
import { OnboardingQcRoutingModule } from './onboarding-qc-routing.module';
...
@NgModule({
  declarations: [
    ...
    // ScaleComponent,
    // ScaleListComponent, UserEndUiComponent, ConfigureDisplayComponent, SearchbarViewComponent,
    // FakeComponent, 
    // FormUiComponent,
    ...
    //  LifecycleListComponent,
     SelfserviceQclistComponent,
     SelfserviceQcComponent,
     InvestmentsQclistComponent,
     InvestmentsQcComponent,
     ExemptionQcComponent,
    //  InvestmentpreviewComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    // ExpenseModule,
    OnboardingQcRoutingModule
  ],
  //exports: [NgZorroAntdModule, UniquePipe],
...
export class OnboardingQcModule {
