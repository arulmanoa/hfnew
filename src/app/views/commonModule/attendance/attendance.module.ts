...
import { ManagerAttendanceListComponent } from '../../attendance/manager-attendance-list/manager-attendance-list.component';
import { DeviceDetectorModule, DeviceDetectorService } from 'ngx-device-detector';
import { AttendancereportComponent } from '../../attendance/attendancereport/attendancereport.component';
...
@NgModule({
  declarations: [
    ...
    AttendanceComponent,
    ManagerAttendanceListComponent,
    AttendancereportComponent,
    AttendanceMonthlyReportComponent,
    AtteandanceBreakUpDetailsComponent,
    //EmployeeMyRequestsUiComponent
    EmployeeRegularizeApprovalRejectionComponent,
    AttendanceBaseReportComponent,
    ViewShiftsByEmployeeComponent,
    ViewAllEmployeeShiftsComponent,
    AttendanceSummaryReportViewComponent,
    AttendanceSummaryDailyViewReportComponent,
    AttendanceReportForItcComponent,
    MonthlyLeaveRequestReportForITCComponent,
    EmployeeAttendanceViewComponent,
    BiometricPunchToolComponent,
    EmployeeAttendanceManagerViewComponent,
    BulkUploadLeaveAttendanceComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
