...
import { PaysheetverificationReqComponent } from '../../payroll/paysheet_request/paysheetverification-req/paysheetverification-req.component';
import { TaxcomputationComponent } from '../../payroll/taxcomputation/taxcomputation.component';

@NgModule({
  declarations: [
    //RowDataService,
    SalarytransactionComponent,
    PayrollinputtransactionComponent,
    SaleordersComponent,
    PayoutComponent,
    ReimbursementComponent,
    AdhocPaymentsComponent,
    PaysheetverificationReqComponent,
