...
import { GenericUiRoutingModule } from './generic-ui-routing.module';
...
import { CardbarViewComponent } from '../../personalised-display/cardbar-view/cardbar-view.component';
...
@NgModule({
  declarations: [
    ...
    CardbarViewComponent,
    InvestmentpreviewComponent,
    ReimbursementforfinanceComponent,
    ClientComponent,
    TeamComponent,
    CostcodeComponent
    // ProfileComponent,
  ...
  imports: [
    ...
    AngularSlickgridModule.forRoot({
      ...
      pagination: {
        pageSizes: [10, 15, 20, 50, 75, 100, 150, 200, 300, 500],
        pageSize: 15   
      },
    }),
